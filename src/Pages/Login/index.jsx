...
const Login = () =>{
    ...
    return (
        <LayoutCenterItems>
            <div className=" w-4/5 h-3/5 flex flex-col items-center bg-cyan-50 md:w-6/12  ">
                <UserCircleIcon className=" w-40 h-40 text-cyan-800 mt-4" />
                <h1 className=" mt-4 text-3xl font-medium text-black text-center ">Bienvenido a KamCatch</h1>
                <form onSubmit={ validateInfo } className="mt-4 flex flex-col" >
                        <input 
                            type="text" 
                            placeholder="Usuario" 
